...
const services = [
  ...
  },
  {
    ...
    description:
      "Creamos aplicaciones móviles intuitivas para iOS y Android que ofrecen un rendimiento fluido y una excelente experiencia de usuario (UX).",
    color: "orange",
  },
  {
    icon: "🎨",
  ...
  return (
    <section className="expertise-block">
      <div className="expertise-header">
        ...
        <p>
          Ofrecemos soluciones digitales modernas y escalables para ayudar a su
          empresa a prosperar en el mundo digital.
        </p>
      </div>
